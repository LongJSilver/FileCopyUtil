...
namespace FileCopyUtil
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			int firstSpaceIndex = commands.IndexOf(' ');
			if (firstSpaceIndex > -1 && firstSpaceIndex + 1 < commands.Length) commands = Environment.CommandLine.Substring(firstSpaceIndex + 1);
			else commands = "";
